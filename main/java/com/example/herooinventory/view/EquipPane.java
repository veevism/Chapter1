...
public class EquipPane extends ScrollPane {
    ...
    private Pane getDetailsPane() {
        ...
        Button unEquipbutt = new Button();
        unEquipbutt.setText("Unequipment");
        unEquipbutt.setOnAction(new AllCustomHandler.UnEquip());

        equipmentInfoPane.getChildren().addAll(weaponLbl,weaponImgGroup,armorLbl,armorImgGroup,unEquipbutt);
